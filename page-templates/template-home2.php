					...
					<div id="main" class="" role="main">
						<div id="sec1" class="widget shapely_home_parallax">
							<section class="cover fullscreen image-bg">
								<div class="parallax-window fullscreen" data-parallax="scroll" data-image-src="<?php echo get_site_url(); ?>/wp-content/uploads/Hero-Parallax.jpg" data-ios-fix="true" data-over-scroll-fix="true" data-android-fix="true">
									...
									<div class="row align-children">
										<div class="col-md-11 col-sm-12">
											<div class="owl-carousel owl-theme">
												<div class="item"><img src="<?php echo get_site_url(); ?>/wp-content/uploads/Carousel-1.jpg"/></div>
												<div class="item"><img src="<?php echo get_site_url(); ?>/wp-content/uploads/Carousel-2.jpg"/></div>
												<div class="item"><img src="<?php echo get_site_url(); ?>/wp-content/uploads/Carousel-3.jpg"/></div>
